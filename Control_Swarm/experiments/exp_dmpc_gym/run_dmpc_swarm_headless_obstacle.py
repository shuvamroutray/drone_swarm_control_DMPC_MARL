...
from gym_pybullet_drones.envs.DMPCAviary_Obstacle import DMPCAviary
...
# ])
    ...
    OBSTACLES = [
        np.array([0.0, 1.0, 1.0]),   # center obstacle
...
if __name__ == "__main__":
    out = run_and_record(sim_time_s=30.0, num_drones=2, gui=False)
    print("Saved:", out)
