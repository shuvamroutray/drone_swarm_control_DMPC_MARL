...
from control_swarm.envs.gym_env.DMPCAviary import DMPCAviary
...
# ])
    ...
    env = DMPCAviary(
        ...
        gui=gui,          # HEADLESS run: gui=False
        record=False,
        #target_pos=np.array([2.0, 0.0, 1.5])
        target_pos= TARGETS
    )
...
if __name__ == "__main__":
    out = run_and_record(sim_time_s=40.0, num_drones=2, gui=False)
    print("Saved:", out)
